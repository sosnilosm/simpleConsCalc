...
- Class Main - containing the main logic of the calculator. Validation of the mathematical expression is done using regular expressions.
- Class Arabic - containing the logic of the program with Arabic numbers.
- Class Roman - containing the logic of the program with Roman numbers.
